...
(def- x (macex1 '(pipe (x + y))))
(def- y (macex x))
(test "infix operators"
  (expect x [do [-> x [+ y]]])
  (expect y [do [+ x y]]))

(def- x (macex1 '(pipe (+ x y z))))
(def- y (macex x))
