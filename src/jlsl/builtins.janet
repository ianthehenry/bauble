...
(defbuiltin vec (partial resolve-vec-constructor (primitive-type/float) nil))
(defbuiltin vec2 (partial resolve-vec-constructor (primitive-type/float) 2))
(defbuiltin vec3 (partial resolve-vec-constructor (primitive-type/float) 3))
(defbuiltin vec4 (partial resolve-vec-constructor (primitive-type/float) 4))
...
(typecheck (vec2 [true false]) [:bvec2 -> :vec2])
